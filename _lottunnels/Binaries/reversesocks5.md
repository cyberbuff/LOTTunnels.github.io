...
Created: 2026-09-24
Commands:
  - Command: "ReverseSocks5 -listen :10443 -socks 127.0.0.1:1080"
  ...
  - Command: "ReverseSocks5 -connect $SERVER:10443"
  ...
  - Command: "ReverseSocks5 -connect $SERVER:10443 -tls -k"
...
Detection:
  - Command: "Execution of ReverseSocks5 or a platform-specific ReverseSocks5 binary with -listen or -connect, SOCKS5 proxy or TLS options (-tls, -k), and credential arguments such as -psk, -username, -password, -cert, or -key."
Resources:
